package com.example.telegrammbot.listener;
...
import js6team3.tbot.MenuMaker.MenuMakerCat;
import js6team3.tbot.MenuMaker.MenuMakerDog;
import js6team3.tbot.configuration.MenuCatDescription;
...
//    String CAT_SHELTER_NURSERY_LOCATION;
    ...
    public TelegramBotUpdatesListener(MenuMakerDog menuMakerDog, MenuMakerCat menuMakerCat) {
        this.menuMakerDog = menuMakerDog;
        this.menuMakerCat = menuMakerCat;
    }
...
//        telegramBot.execute(location);
     ...
     * Использует pengrad метод {@link SendMessage } <br>
     * Использует pengrad метод {@link SendDocument } <br>
     *
     * @param chatId идентификатор чата
     */
